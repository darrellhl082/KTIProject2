            ...
            <div class="col-md-8">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control bg-transparent border-dark" type="file" id="formFile" required>
                    </div>
                    <div class="mb-3">
                        <label for="ebook-title" class="form-label">Title</label>
                        <input type="text" class="form-control bg-transparent border-dark" id="ebook-title" required>
                    </div>
                    <div class="mb-3">
                        <label for="Ebook" class="form-label">Upload E-Book</label>
                        <input class="form-control bg-transparent border-dark" type="file" id="Ebook" required>
                    </div>
