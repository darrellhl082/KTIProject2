    ...
    <div class="container main">
        ...
        <div class="row article mt-5 text-black justify-content-between">
            <div class="col-md-8">
                ...
                <span class="author text-muted">Darrell Hammam</span>
                <img src="../img/article-img/img.png" class="img-fluid mt-3 mb-5" alt="">
                <div class="content">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis voluptate numquam aperiam
                        deserunt fugiat facere iste eos dolor quo quasi ipsa nemo dolores, praesentium at laudantium
                        inventore dignissimos expedita mollitia.
                        ...
                        inventore dignissimos expedita mollitia.
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis voluptate numquam aperiam
                        deserunt fugiat facere iste eos dolor quo quasi ipsa nemo dolores, praesentium at
                        laudantium
                        inventore dignissimos expedita mollitia.
                    </p>
                    <p>
                    ...
                    <a href="../img/article-img/img.png" download>Download</a>
                ...
                <ul class="other">
                    <li class="mb-3">
                        <a href="#" class="text-decoration-none text-black">
                            <img src="../img/article-img/img.png" class="img-fluid" alt="">
                            <h5 class="other-title mt-3">Archimedes Laws</h5>
                            <span class="other-desc text-muted mt-n3">Physics</span>
                        </a>
                    </li>
                    <li class="mb-3">
                        <a href="#" class="text-decoration-none text-black">
