        ...
        <div class="row mt-3">
            <div class="col-md-12 menu  align-items-center">
                <ul class="me-auto menuList text-center">
                    ...
                    <li class="d-inline-block me-3 mt-2 mb-2">
                        <a href="e-book/index.html">E-Book</a>
                    </li>
                    <li class="d-inline-block me-3 mt-2 mb-2">
                        <a href="lib-contribute/index.html">Contribute</a>
                    </li>
        ...
        <div class="row mt-4">
            <div class="col-md-3 mb-3">
                <div class="card bg-transparent">
                    <img src="img/article-img/img.png" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Newton's Laws</h5>
                        <p class="card-text text-mute text-secondary">Physics</p>
                        <a href="article/index.html" class="btn btn-outline-dark">Read</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
